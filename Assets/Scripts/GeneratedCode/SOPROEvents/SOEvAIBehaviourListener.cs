...
namespace SOPRO
{
    ...
    /// </summary>
    [Serializable]
    public class SOEvAIBehaviourListener : MonoBehaviour
    {
        [SerializeField]
        [Tooltip("Event to register with.")]
        private SOEvAIBehaviour Event;
        [SerializeField]
        [Tooltip("Response to invoke when Event is raised.")]
        private UnEvAIBehaviour Actions;
        ...
        /// Invokes unity event
        /// </summary>
        internal void OnEventRaised(AIBehaviour Value0)
        {
